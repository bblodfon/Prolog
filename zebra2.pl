...
zebra(Houses):- Houses = [house(norwegian,_,_,_,_),house(_,blue,_,_,_),house(_,_,_,milk,_),_,_],
				...
				member(house(WhoOwnsTheZebra,_,zebra,_,_),Houses), print('The '), print(WhoOwnsTheZebra), print(' has the zebra!!!'), nl,
				member(house(WhoOwnsThePepsi,_,_,pepsi,_),Houses), print('The '), print(WhoOwnsThePepsi), print(' has the pepsi-cola!!!'),!.
right_of(X,Y,[X,Y|_]).
